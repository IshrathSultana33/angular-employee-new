...
export class CrudComponent implements OnInit {
  ...
  employees = [
    {name: 'Harish', id:'7909',phoneno:'56423',location: 'Bangalore'},
    { name: 'Bhargavi',id:'5623',phoneno:'64691', location: 'Hyderabad'},
    { name: 'Abdul',id:'4528',phoneno:'21587', location: 'Bangalore'}
  ];
  ...
  editEmployee(editEmployeeInfo) {
    ...
    this.model2.phoneno = this.employees[editEmployeeInfo].phoneno;
    this.model2.location = this.employees[editEmployeeInfo].location;
